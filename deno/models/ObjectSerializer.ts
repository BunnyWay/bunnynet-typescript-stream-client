...
let typeMap: {[index: string]: any} = {
    ...
    "PaginationListOfCollectionModel": PaginationListOfCollectionModel,
    "PaginationListOfVideoModel": PaginationListOfVideoModel,
    "StatusModel": StatusModel,
    "TranscodingMessageModel": TranscodingMessageModel,
    ...
    "VideoHeatmapModel": VideoHeatmapModel,
    "VideoModel": VideoModel,
    "VideoModelStatus": VideoModelStatus,
    "VideoOEmbedModel": VideoOEmbedModel,
    "VideoPlayDataModel": VideoPlayDataModel,
    "VideoPlayDataModelVideo": VideoPlayDataModelVideo,
